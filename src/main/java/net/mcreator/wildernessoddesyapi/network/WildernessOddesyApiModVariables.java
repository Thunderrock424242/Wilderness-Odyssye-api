...
public class WildernessOddesyApiModVariables {
	...
	public static void init(FMLCommonSetupEvent event) {
		WildernessOddesyApiMod.addNetworkMessage(PlayerVariablesSyncMessage.ID, PlayerVariablesSyncMessage::new, PlayerVariablesSyncMessage::handleData);
	}
	...
	public record PlayerVariablesSyncMessage(PlayerVariables data) implements CustomPacketPayload {
		public static final ResourceLocation ID = new ResourceLocation(WildernessOddesyApiMod.MODID, "player_variables_sync");
