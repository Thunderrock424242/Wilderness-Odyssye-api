...
import net.mcreator.wildernessoddesyapi.block.LightingBlockBlock;
...
public class WildernessOddesyApiModBlocks {
	...
	public static final DeferredHolder<Block, Block> LIGHTING_BLOCK = REGISTRY.register("lighting_block", () -> new LightingBlockBlock());
