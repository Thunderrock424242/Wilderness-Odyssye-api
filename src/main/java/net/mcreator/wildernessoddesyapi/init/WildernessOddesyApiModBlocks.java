...
import net.mcreator.wildernessoddesyapi.block.LightingenergyblockBlock;
...
public class WildernessOddesyApiModBlocks {
	...
	public static final DeferredHolder<Block, Block> LIGHTINGENERGYBLOCK = REGISTRY.register("lightingenergyblock", () -> new LightingenergyblockBlock());
