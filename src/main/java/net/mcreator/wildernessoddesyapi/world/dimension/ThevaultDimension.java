...
package net.mcreator.wildernessoddesyapi.world.dimension;
...
public class ThevaultDimension {
	...
	public static class DimensionSpecialEffectsHandler {
		...
		public static void registerDimensionSpecialEffects(RegisterDimensionSpecialEffectsEvent event) {
			...
			event.register(new ResourceLocation("wilderness_oddesy_api:thevault"), customEffect);
		}
	}
}
