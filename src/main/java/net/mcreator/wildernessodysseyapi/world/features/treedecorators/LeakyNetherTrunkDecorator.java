...
public class LeakyNetherTrunkDecorator extends TrunkVineDecorator {
	public static MapCodec<LeakyNetherTrunkDecorator> CODEC = MapCodec.unit(LeakyNetherTrunkDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("wilderness_odyssey_api:leaky_nether_tree_trunk_decorator"), () -> DECORATOR_TYPE);
	}
