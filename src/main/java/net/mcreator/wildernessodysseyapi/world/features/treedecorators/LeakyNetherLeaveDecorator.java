...
public class LeakyNetherLeaveDecorator extends LeaveVineDecorator {
	public static MapCodec<LeakyNetherLeaveDecorator> CODEC = MapCodec.unit(LeakyNetherLeaveDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("wilderness_odyssey_api:leaky_nether_tree_leave_decorator"), () -> DECORATOR_TYPE);
	}

	public LeakyNetherLeaveDecorator() {
		super(0.25f);
	}
