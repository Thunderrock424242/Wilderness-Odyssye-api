...
public class ModWorldGeneration {
    ...
    public static void addBiomeFeatures() {
        ...
        addBiomeFeature(ModBiomes.CRIMSON_FOREST_BIOME, ModPlacedFeatures.CRIMSON_TREES);
        addBiomeFeature(ModBiomes.WARPED_FOREST_BIOME, ModPlacedFeatures.WARPED_TREES);
    }
